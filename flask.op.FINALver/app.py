...
def view_uploaded_database():
    ...
    on the 'view_uploaded_database.html' page. This allows users to see which files have been
    ...
    Returns:
        render_template: This function renders the 'view_uploaded_database.html' template, 
...
def view_database():
    ...
    """
    Endpoint to view the details of the uploaded database files.

    This function is triggered via a GET request and is responsible for rendering a page that
    displays the contents of the two uploaded CSV database files. It expects 'filename1' and
    ...
    Returns:
        render_template: Renders the 'view_database.html' template with the table data and filenames
